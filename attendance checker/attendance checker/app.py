...
def edit_student(student_id):
    ...
    try:
        ...
        if profile_picture:
            ...
            # Update the student record, including the new profile picture
            cursor.execute('''
                UPDATE student_info
                SET first_name = %s, last_name = %s, parent = %s, gender = %s, profile_pic = %s
                WHERE id = %s
            ''', (first_name, last_name, parent_name, gender, profile_pic_path, student_id))
        else:
            # Update the student record without changing the profile picture
            cursor.execute('''
                UPDATE student_info
                SET first_name = %s, last_name = %s, parent = %s, gender = %s
                WHERE id = %s
            ''', (first_name, last_name, parent_name, gender, student_id))
        ...
        # If there is an error, return failure response with error message
